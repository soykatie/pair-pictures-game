...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_5_Cars::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_5_Cars::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_5_Cars
			// 
			...
			this->Text = L"\"Ã‡ÍË ‡‚ÚÓÏÓ·ËÎÂÈ\" | ”Ó‚ÂÌ¸ 5";
