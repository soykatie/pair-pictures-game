...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_1_Cars
	/// </summary>
	public ref class Level_1_Cars : public System::Windows::Forms::Form
	{
	private:
		array<Image^>^ cars;
		array<int>^ index;
		Button^ firstCar;
		int firstIndex, found = 0, movement;
		int numBonuses = 0, numLevels = 0;
	...
	public:
		Level_1_Cars(void)
		{
			...
			cars = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl1\\cars\\bmw.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl1\\cars\\ford.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl1\\cars\\toyota.png"),
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button6->Click += gcnew System::EventHandler(this, &Level_1_Cars::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &Level_1_Cars::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Level_1_Cars::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Level_1_Cars::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Level_1_Cars::button1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_1_Cars::button1_Click);
			// 
			// label1
			// 
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_1_Cars::timer1_Tick);
			// 
			// label4
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_1_Cars::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_1_Cars::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_1_Cars
			// 
			...
			this->Name = L"Level_1_Cars";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"Ã‡ÍË ‡‚ÚÓÏÓ·ËÎÂÈ\" | ”Ó‚ÂÌ¸ 1";
			this->Load += gcnew System::EventHandler(this, &Level_1_Cars::Level_1_Cars_Load);
...
#pragma endregion
private: System::Void Level_1_Cars_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
