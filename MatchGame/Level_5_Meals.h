...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_5_Meals
	/// </summary>
	public ref class Level_5_Meals : public System::Windows::Forms::Form
	{
	private:
		array<Image^>^ meals;
		array<int>^ index;
	...
	public:
		Level_5_Meals(void)
		{
			...
			meals = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\apple.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\onion.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\grapes.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\tomato.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\strawberry.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\bilberry.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\lemon.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\peach.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\banana.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\cherry.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\pineapple.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\pear.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\raspberry.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\meals\\orange.png"),
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button28->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button27
			// 
			...
			this->button27->TabIndex = 181;
			this->button27->UseVisualStyleBackColor = false;
			this->button27->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button26
			// 
			...
			this->button26->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button25
			// 
			...
			this->button25->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button24
			// 
			...
			this->button24->TabIndex = 178;
			this->button24->UseVisualStyleBackColor = false;
			this->button24->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button23
			// 
			...
			this->button23->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button22
			// 
			...
			this->button22->TabIndex = 176;
			this->button22->UseVisualStyleBackColor = false;
			this->button22->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button21
			// 
			...
			this->button21->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button20
			// 
			...
			this->button20->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button19
			// 
			...
			this->button19->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button18
			// 
			...
			this->button18->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button17
			// 
			...
			this->button17->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button16
			// 
			...
			this->button16->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_5_Meals::button1_Click);
			// 
			// label1
			// 
			...
			this->secondsLabel->TabIndex = 184;
			...
			this->minutesLabel->TabIndex = 183;
			this->minutesLabel->Text = L"MM";
			// 
			// timer1
			// 
			this->timer1->Interval = 1000;
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_5_Meals::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_5_Meals::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_5_Meals::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_5_Meals
			// 
			...
			this->Name = L"Level_5_Meals";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"≈‰‡\" | ”Ó‚ÂÌ¸ 5";
			this->Load += gcnew System::EventHandler(this, &Level_5_Meals::Level_5_Meals_Load);
...
#pragma endregion
private: System::Void Level_5_Meals_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
