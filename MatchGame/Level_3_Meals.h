...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_3_Meals
	/// </summary>
	public ref class Level_3_Meals : public System::Windows::Forms::Form
	{
	private:
		array<Image^>^ meals;
		array<int>^ index;
	...
	public:
		Level_3_Meals(void)
		{
			...
			meals = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\apple.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\onion.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\grapes.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\tomato.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\peach.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\banana.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\pear.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\raspberry.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\meals\\orange.png"),
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button18->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button17
			// 
			...
			this->button17->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button16
			// 
			...
			this->button16->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_3_Meals::button1_Click);
			// 
			// label1
			// 
			...
			this->label3->Location = System::Drawing::Point(434, 143);
			...
			this->secondsLabel->Location = System::Drawing::Point(469, 144);
			this->secondsLabel->Name = L"secondsLabel";
			this->secondsLabel->Size = System::Drawing::Size(43, 33);
			this->secondsLabel->TabIndex = 108;
			...
			this->minutesLabel->Location = System::Drawing::Point(367, 144);
			this->minutesLabel->Name = L"minutesLabel";
			this->minutesLabel->Size = System::Drawing::Size(61, 33);
			this->minutesLabel->TabIndex = 107;
			this->minutesLabel->Text = L"MM";
			// 
			// timer1
			// 
			this->timer1->Interval = 1000;
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_3_Meals::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_3_Meals::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_3_Meals::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_3_Meals
			// 
			...
			this->Name = L"Level_3_Meals";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"≈‰‡\" | ”Ó‚ÂÌ¸ 3";
			this->Load += gcnew System::EventHandler(this, &Level_3_Meals::Level_3_Meals_Load);
...
#pragma endregion
private: System::Void Level_3_Meals_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
