...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_2_Princesses
	/// </summary>
	public ref class Level_2_Princesses : public System::Windows::Forms::Form
	{
	private:
	...
	public:
		Level_2_Princesses(void)
		{
			InitializeComponent();
			princesses = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\princesses\\ariel.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\princesses\\aurora.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\princesses\\belle.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\princesses\\snowwhite.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\princesses\\rapunzel.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\princesses\\cinderella.png")
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// label1
			// 
			...
			this->button2->Location = System::Drawing::Point(315, 160);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(120, 120);
			this->button2->TabIndex = 36;
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Location = System::Drawing::Point(469, 160);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(120, 120);
			this->button3->TabIndex = 37;
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button7
			// 
			...
			this->button7->Location = System::Drawing::Point(616, 160);
			this->button7->Name = L"button7";
			this->button7->Size = System::Drawing::Size(120, 120);
			this->button7->TabIndex = 38;
			this->button7->UseVisualStyleBackColor = false;
			this->button7->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Location = System::Drawing::Point(469, 296);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(120, 120);
			this->button4->TabIndex = 39;
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Location = System::Drawing::Point(315, 431);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(120, 120);
			this->button5->TabIndex = 40;
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button6
			// 
			...
			this->button6->Location = System::Drawing::Point(315, 296);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(120, 120);
			this->button6->TabIndex = 41;
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button10
			// 
			...
			this->button10->Location = System::Drawing::Point(616, 431);
			this->button10->Name = L"button10";
			this->button10->Size = System::Drawing::Size(120, 120);
			this->button10->TabIndex = 44;
			this->button10->UseVisualStyleBackColor = false;
			this->button10->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button11
			// 
			...
			this->button11->Location = System::Drawing::Point(616, 296);
			this->button11->Name = L"button11";
			this->button11->Size = System::Drawing::Size(120, 120);
			this->button11->TabIndex = 45;
			this->button11->UseVisualStyleBackColor = false;
			this->button11->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// button12
			// 
			...
			this->button12->Location = System::Drawing::Point(469, 431);
			this->button12->Name = L"button12";
			this->button12->Size = System::Drawing::Size(120, 120);
			this->button12->TabIndex = 46;
			this->button12->UseVisualStyleBackColor = false;
			this->button12->Click += gcnew System::EventHandler(this, &Level_2_Princesses::button1_Click);
			// 
			// label4
			// 
			...
			this->secondsLabel->Location = System::Drawing::Point(566, 103);
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_2_Princesses::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_2_Princesses::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_2_Princesses::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_2_Princesses
			// 
			...
			this->Name = L"Level_2_Princesses";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"œËÌˆÂÒÒ˚\" | ”Ó‚ÂÌ¸ 2";
			this->Load += gcnew System::EventHandler(this, &Level_2_Princesses::Level_2_Princesses_Load);
...
#pragma endregion
private: System::Void Level_2_Princesses_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
