...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_1_Meals
	/// </summary>
	public ref class Level_1_Meals : public System::Windows::Forms::Form
	{
	private:
		array<Image^>^ meals;
		array<int>^ index;
	...
	public:
		Level_1_Meals(void)
		{
			...
			meals = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl1\\meals\\apple.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl1\\meals\\onion.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl1\\meals\\orange.png"),
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button6->Click += gcnew System::EventHandler(this, &Level_1_Meals::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &Level_1_Meals::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Level_1_Meals::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Level_1_Meals::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Level_1_Meals::button1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_1_Meals::button1_Click);
			// 
			// label1
			// 
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_1_Meals::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_1_Meals::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_1_Meals::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_1_Meals
			// 
			...
			this->Name = L"Level_1_Meals";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"≈‰‡\" | ”Ó‚ÂÌ¸ 1";
			this->Load += gcnew System::EventHandler(this, &Level_1_Meals::Level_1_Meals_Load);
...
#pragma endregion
private: System::Void Level_1_Meals_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
