...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button15->Location = System::Drawing::Point(300, 270);
			this->button15->Name = L"button15";
			this->button15->Size = System::Drawing::Size(311, 80);
			this->button15->TabIndex = 106;
			this->button15->Text = L"Информация о пользователях";
			this->button15->UseVisualStyleBackColor = false;
			this->button15->Click += gcnew System::EventHandler(this, &Admin_Screen::button15_Click);
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Font = (gcnew System::Drawing::Font(L"Showcard Gothic", 30, System::Drawing::FontStyle::Italic));
			this->label1->Location = System::Drawing::Point(289, 171);
			...
			this->button1->Location = System::Drawing::Point(300, 376);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(311, 80);
			this->button1->TabIndex = 107;
			this->button1->Text = L"Выход";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Admin_Screen::button1_Click);
			// 
			// Admin_Screen
			// 
			...
			this->Text = L"Главный экран администратора";
...
#pragma endregion
	private: System::Void button15_Click(System::Object^ sender, System::EventArgs^ e) {
		BD_Users_Info^ info = gcnew BD_Users_Info();
		info->ShowDialog();
	}
