...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_2_Cars
	/// </summary>
	public ref class Level_2_Cars : public System::Windows::Forms::Form
	{
	private:
		array<Image^>^ cars;
		array<int>^ index;
	...
	public:
		Level_2_Cars(void)
		{
			...
			cars = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\cars\\bmw.png"),
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\cars\\audi.png"),
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\cars\\bentley.png"),
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\cars\\nissan.png"),
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\cars\\ford.png"),
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl2\\cars\\toyota.png")
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button12->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_2_Cars::button1_Click);
			// 
			// label1
			// 
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_2_Cars::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_2_Cars::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_2_Cars::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_2_Cars
			// 
			...
			this->Name = L"Level_2_Cars";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"Ã‡ÍË ‡‚ÚÓÏÓ·ËÎÂÈ\" | ”Ó‚ÂÌ¸ 2";
			this->Load += gcnew System::EventHandler(this, &Level_2_Cars::Level_2_Cars_Load);
...
#pragma endregion
private: System::Void Level_2_Cars_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
