...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_4_Cars
	/// </summary>
	public ref class Level_4_Cars : public System::Windows::Forms::Form
	{
	private:
		array<Image^>^ cars;
		array<int>^ index;
	...
	public:
		Level_4_Cars(void)
		{
			...
			cars = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\bmw.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\audi.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\bentley.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\nissan.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\ford.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\maserati.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\jaguar.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\landrover.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\lexus.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\mercedes.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\peugeot.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl4\\cars\\toyota.png")
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button24->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button23
			// 
			...
			this->button23->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button22
			// 
			...
			this->button22->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button21
			// 
			...
			this->button21->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button20
			// 
			...
			this->button20->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button19
			// 
			...
			this->button19->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button18
			// 
			...
			this->button18->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button17
			// 
			...
			this->button17->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button16
			// 
			...
			this->button16->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_4_Cars::button1_Click);
			// 
			// label1
			// 
			...
			this->secondsLabel->TabIndex = 120;
			...
			this->minutesLabel->TabIndex = 119;
			this->minutesLabel->Text = L"MM";
			// 
			// timer1
			// 
			this->timer1->Interval = 1000;
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_4_Cars::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_4_Cars::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_4_Cars::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_4_Cars
			// 
			...
			this->Name = L"Level_4_Cars";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"Ã‡ÍË ‡‚ÚÓÏÓ·ËÎÂÈ\" | ”Ó‚ÂÌ¸ 4";
			this->Load += gcnew System::EventHandler(this, &Level_4_Cars::Level_4_Cars_Load);
...
#pragma endregion
private: System::Void Level_4_Cars_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
