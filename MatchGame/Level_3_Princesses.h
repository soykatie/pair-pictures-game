...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_3_Princesses
	/// </summary>
	public ref class Level_3_Princesses : public System::Windows::Forms::Form
	{
	private:
	...
	public:
		Level_3_Princesses(void)
		{
			InitializeComponent();
			princesses = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\ariel.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\aurora.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\cinderella.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\snowwhite.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\rapunzel.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\tiana.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\mulan.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\belle.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl3\\princesses\\moana.png")
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(198, 196);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(105, 105);
			this->button2->TabIndex = 50;
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Location = System::Drawing::Point(329, 196);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(105, 105);
			this->button3->TabIndex = 51;
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Location = System::Drawing::Point(461, 196);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(105, 105);
			this->button4->TabIndex = 52;
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Location = System::Drawing::Point(591, 196);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(105, 105);
			this->button5->TabIndex = 53;
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button6
			// 
			...
			this->button6->Location = System::Drawing::Point(723, 196);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(105, 105);
			this->button6->TabIndex = 54;
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button8
			// 
			...
			this->button8->Location = System::Drawing::Point(198, 318);
			this->button8->Name = L"button8";
			this->button8->Size = System::Drawing::Size(105, 105);
			this->button8->TabIndex = 56;
			this->button8->UseVisualStyleBackColor = false;
			this->button8->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button9
			// 
			...
			this->button9->Location = System::Drawing::Point(329, 318);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(105, 105);
			this->button9->TabIndex = 57;
			this->button9->UseVisualStyleBackColor = false;
			this->button9->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button10
			// 
			...
			this->button10->Location = System::Drawing::Point(461, 318);
			this->button10->Name = L"button10";
			this->button10->Size = System::Drawing::Size(105, 105);
			this->button10->TabIndex = 58;
			this->button10->UseVisualStyleBackColor = false;
			this->button10->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button11
			// 
			...
			this->button11->Location = System::Drawing::Point(591, 318);
			this->button11->Name = L"button11";
			this->button11->Size = System::Drawing::Size(105, 105);
			this->button11->TabIndex = 59;
			this->button11->UseVisualStyleBackColor = false;
			this->button11->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button12
			// 
			...
			this->button12->Location = System::Drawing::Point(723, 318);
			this->button12->Name = L"button12";
			this->button12->Size = System::Drawing::Size(105, 105);
			this->button12->TabIndex = 60;
			this->button12->UseVisualStyleBackColor = false;
			this->button12->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button14
			// 
			...
			this->button14->Location = System::Drawing::Point(198, 441);
			this->button14->Name = L"button14";
			this->button14->Size = System::Drawing::Size(105, 105);
			this->button14->TabIndex = 62;
			this->button14->UseVisualStyleBackColor = false;
			this->button14->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button15
			// 
			...
			this->button15->Location = System::Drawing::Point(329, 441);
			this->button15->Name = L"button15";
			this->button15->Size = System::Drawing::Size(105, 105);
			this->button15->TabIndex = 63;
			this->button15->UseVisualStyleBackColor = false;
			this->button15->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button16
			// 
			...
			this->button16->Location = System::Drawing::Point(461, 441);
			this->button16->Name = L"button16";
			this->button16->Size = System::Drawing::Size(105, 105);
			this->button16->TabIndex = 64;
			this->button16->UseVisualStyleBackColor = false;
			this->button16->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button17
			// 
			...
			this->button17->Location = System::Drawing::Point(591, 441);
			this->button17->Name = L"button17";
			this->button17->Size = System::Drawing::Size(105, 105);
			this->button17->TabIndex = 65;
			this->button17->UseVisualStyleBackColor = false;
			this->button17->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// button18
			// 
			...
			this->button18->Location = System::Drawing::Point(723, 441);
			this->button18->Name = L"button18";
			this->button18->Size = System::Drawing::Size(105, 105);
			this->button18->TabIndex = 66;
			this->button18->UseVisualStyleBackColor = false;
			this->button18->Click += gcnew System::EventHandler(this, &Level_3_Princesses::button1_Click);
			// 
			// label4
			// 
			...
			this->label3->Location = System::Drawing::Point(444, 143);
			...
			this->minutesLabel->TabIndex = 92;
			this->minutesLabel->Text = L"MM";
			// 
			// timer1
			// 
			this->timer1->Interval = 1000;
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_3_Princesses::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_3_Princesses::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_3_Princesses::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_3_Princesses
			// 
			...
			this->Name = L"Level_3_Princesses";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"œËÌˆÂÒÒ˚\" | ”Ó‚ÂÌ¸ 3";
			this->Load += gcnew System::EventHandler(this, &Level_3_Princesses::Level_3_Princesses_Load);
...
#pragma endregion
private: System::Void Level_3_Princesses_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
