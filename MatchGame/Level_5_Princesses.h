...
namespace MatchGame {
	...
	/// <summary>
	/// Summary for Level_5_Princesses
	/// </summary>
	public ref class Level_5_Princesses : public System::Windows::Forms::Form
	{
	private:
	...
	public:
		Level_5_Princesses(void)
		{
			InitializeComponent();
			princesses = gcnew array<Image^> {
				Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\ariel.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\aurora.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\belle.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\snowwhite.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\rapunzel.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\elsa.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\moana.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\mulan.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\pakahontas.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\sofia.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\tiana.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\anna.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\esmeralda.png"),
					Image::FromFile(Application::StartupPath + "\\Pictures\\lvl5\\princesses\\cinderella.png")
			};
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// label1
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button16
			// 
			...
			this->button16->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button17
			// 
			...
			this->button17->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button18
			// 
			...
			this->button18->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button19
			// 
			...
			this->button19->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button20
			// 
			...
			this->button20->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button21
			// 
			...
			this->button21->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button22
			// 
			this->button22->BackColor = System::Drawing::Color::PaleVioletRed;
			...
			this->button22->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button23
			// 
			this->button23->BackColor = System::Drawing::Color::PaleVioletRed;
			...
			this->button23->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button24
			// 
			this->button24->BackColor = System::Drawing::Color::PaleVioletRed;
			...
			this->button24->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button25
			// 
			...
			this->button25->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button26
			// 
			...
			this->button26->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button27
			// 
			this->button27->BackColor = System::Drawing::Color::PaleVioletRed;
			...
			this->button27->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// button28
			// 
			this->button28->BackColor = System::Drawing::Color::PaleVioletRed;
			...
			this->button28->Click += gcnew System::EventHandler(this, &Level_5_Princesses::button1_Click);
			// 
			// label4
			// 
			...
			this->secondsLabel->Location = System::Drawing::Point(488, 129);
			this->secondsLabel->Name = L"secondsLabel";
			this->secondsLabel->Size = System::Drawing::Size(43, 33);
			this->secondsLabel->TabIndex = 124;
			...
			this->minutesLabel->TabIndex = 123;
			this->minutesLabel->Text = L"MM";
			// 
			// timer1
			// 
			this->timer1->Interval = 1000;
			this->timer1->Tick += gcnew System::EventHandler(this, &Level_5_Princesses::timer1_Tick);
			// 
			// menuStrip1
			// 
			...
			this->ÌÓ‚‡ˇ»„‡ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_5_Princesses::ÌÓ‚‡ˇ»„‡ToolStripMenuItem_Click);
			// 
			...
			this->‚˚ıÓ‰ToolStripMenuItem->Click += gcnew System::EventHandler(this, &Level_5_Princesses::‚˚ıÓ‰ToolStripMenuItem_Click);
			// 
			// Level_5_Princesses
			// 
			...
			this->Name = L"Level_5_Princesses";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"\"œËÌˆÂÒÒ˚\" | ”Ó‚ÂÌ¸ 5";
			this->Load += gcnew System::EventHandler(this, &Level_5_Princesses::Level_5_Princesses_Load);
...
#pragma endregion
private: System::Void Level_5_Princesses_Load(System::Object^ sender, System::EventArgs^ e) {
	updateCards();
